...
three fictional countries. Around the world, different countries have different voting ages.
...
def main():
    ...
    # First country statement
    if user_age >= PETURKSBOUIPO_AGE:
        print("You can vote in Peturksbouipo where the voting age is " + str(PETURKSBOUIPO_AGE) + ".")
    else:
        print("You cannot vote in Peturksbouipo where the voting age is " + str(PETURKSBOUIPO_AGE) + ".")

    # Second country statement
    if user_age >= STANLAU_AGE:
        print("You can vote in Peturksbouipo where the voting age is " + str(STANLAU_AGE) + ".")
    else:
        print("You cannot vote in Peturksbouipo where the voting age is " + str(STANLAU_AGE) + ".")

    # Third country statement
